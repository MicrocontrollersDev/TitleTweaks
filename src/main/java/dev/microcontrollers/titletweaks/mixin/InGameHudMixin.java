...
public class InGameHudMixin {
    ...
    private int renderWithoutShadow(DrawContext context, TextRenderer textRenderer, Text text, int x, int y, int color, Operation<Integer> original) {
        if (TitleTweaksConfig.CONFIG.instance().removeTextShadow) return context.drawText(textRenderer, text, x, y, color, false);
